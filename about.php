    ...
    <div class="flex-container">
        ...
        <div class="about_logobox">
            ...
            <p class="main__txt">
                ...
                アクティブエイジングには、正しい“姿勢・背骨”と適切な“動き”が重要です。<br>
                <br>
                カイロプラクティックとピラティスを通して<br>
                正しい姿勢・背骨と適切な動きを身につけ、アクティブエイジングを実現しましょう。
            </p>
        </div>
...
<div class="home__area">
    <div class="flex-container">
        <h2 class="main__ttl">STRENGTH<span>私たちの強み</span></h2>
...
<div class="home__area home__area--bg">
    ...
    <div class="flex-fluid justify-center mt24">
        <a href="<?php echo esc_url(home_url('/').'clinic-information'); ?>" class="more__btn">
            当院について
        </a>
    </div>
</div>
